...
import org.nodebasej.core.*;
import org.nodebasej.core.TransactionConfidence.*;
import org.nodebasej.core.listeners.*;
import org.nodebasej.crypto.*;
import org.nodebasej.script.*;
import org.nodebasej.signers.*;
import org.nodebasej.utils.*;
import org.nodebasej.wallet.Protos.Wallet.*;
import org.nodebasej.wallet.WalletTransaction.*;
import org.nodebasej.wallet.listeners.KeyChainEventListener;
import org.nodebasej.wallet.listeners.ScriptsChangeEventListener;
...
import org.nodebasej.wallet.listeners.WalletCoinsSentEventListener;
import org.nodebasej.wallet.listeners.WalletEventListener;
import org.nodebasej.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.nodebasej.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.nodebasej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.nodebasej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.nodebasej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.nodebasej.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.nodebasej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.nodebasej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.nodebasej.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.nodebasej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.nodebasej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.nodebasej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.nodebasej.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.nodebasej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.nodebasej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.nodebasej.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.nodebasej.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.nodebasej.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.nodebasej.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.nodebasej.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.nodebasej.crypto.KeyCrypter,
     ...
     * {@link org.nodebasej.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.nodebasej.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.nodebasej.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.nodebasej.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.nodebasej.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
