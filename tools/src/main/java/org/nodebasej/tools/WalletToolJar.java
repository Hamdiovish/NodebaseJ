/*
MnemonicCode class: [ancient, only, party, old, oppose, curtain, correct, iron, anger, aunt, fresh, trim], passphrase: , 
toSeed: a2393a4f10ab4879cca077166a417719d6e38e56288e0704029e3f6c52b453ddb003eb620046ac003f134c78853192b93c36bbbcb90043f194864564cdf8e458
 * */ 
/*
...
package org.nodebasej.tools;

import org.nodebasej.core.*;
import org.nodebasej.crypto.*;
import org.nodebasej.net.discovery.DnsDiscovery;
...
import org.nodebasej.protocols.payments.PaymentProtocol;
import org.nodebasej.protocols.payments.PaymentProtocolException;
import org.nodebasej.protocols.payments.PaymentSession;
import org.nodebasej.script.ScriptBuilder;
import org.nodebasej.store.*;
import org.nodebasej.uri.BitcoinURIParseException;
import org.nodebasej.uri.PivxURI;
import org.nodebasej.utils.BriefLogFormatter;
import org.nodebasej.wallet.DeterministicSeed;
import org.nodebasej.wallet.DeterministicUpgradeRequiredException;
import org.nodebasej.wallet.DeterministicUpgradeRequiresPassword;
...
import static org.nodebasej.core.Coin.parseCoin;
import static com.google.common.base.Preconditions.checkNotNull;

/**
 * A command line tool for manipulating wallets and working with Bitcoin.
 */
public class WalletToolJar {
    private static final Logger log = LoggerFactory.getLogger(WalletToolJar.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 0 || options.has("help") ||
            ...
            System.out.println(Resources.toString(WalletToolJar.class.getResource("wallet-tool-help.txt"), Charsets.UTF_8));
            return;
        }
    ...
    private static void syncChain() {
        try {
            ...
            System.out.println(">>startTransactions:"+startTransactions);
