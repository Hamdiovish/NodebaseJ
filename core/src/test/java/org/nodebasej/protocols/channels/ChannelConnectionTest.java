...
package org.nodebasej.protocols.channels;

import org.nodebasej.core.*;
import org.nodebasej.protocols.channels.PaymentChannelClient;
import org.nodebasej.protocols.channels.PaymentChannelClientConnection;
import org.nodebasej.protocols.channels.PaymentChannelClientState;
import org.nodebasej.protocols.channels.PaymentChannelCloseException;
import org.nodebasej.protocols.channels.PaymentChannelServer;
import org.nodebasej.protocols.channels.PaymentChannelServerListener;
import org.nodebasej.protocols.channels.PaymentChannelServerState;
import org.nodebasej.protocols.channels.PaymentChannelV1ServerState;
import org.nodebasej.protocols.channels.PaymentChannelV2ClientState;
import org.nodebasej.protocols.channels.PaymentIncrementAck;
import org.nodebasej.protocols.channels.ServerConnectionEventHandler;
import org.nodebasej.protocols.channels.StoredPaymentChannelClientStates;
import org.nodebasej.protocols.channels.StoredPaymentChannelServerStates;
import org.nodebasej.protocols.channels.StoredServerChannel;
import org.nodebasej.testing.TestWithWallet;
import org.nodebasej.utils.Threading;
...
import static org.nodebasej.core.Coin.*;
import static org.nodebasej.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.nodebasej.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.nodebasej.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
