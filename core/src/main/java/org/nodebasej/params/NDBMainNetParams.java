...
public class NDBMainNetParams
  extends AbstractBitcoinNetParams
{
  public static final int MAINNET_MAJORITY_WINDOW = 1000;
  public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
  public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;
  private static NDBMainNetParams instance;
  
  public NDBMainNetParams()
  {
    interval = 1440;
  ...
  public static synchronized NDBMainNetParams get()
  {
    if (instance == null) {
      instance = new NDBMainNetParams();
    }
    return instance;
  }
