 ...
 */
public class PIVXMainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public PIVXMainNetParams() {
        super();
        interval = INTERVAL;
    ...
    private static PIVXMainNetParams instance;
    public static synchronized PIVXMainNetParams get() {
        if (instance == null) {
            instance = new PIVXMainNetParams();
        }
        return instance;
    }
