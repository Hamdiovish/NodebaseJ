...
import org.nodebasej.core.BloomFilter;
 ...
 * {@link org.nodebasej.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.nodebasej.crypto.MnemonicCode},
 ...
 * {@link org.nodebasej.crypto.DeterministicKey#serializePubB58(org.nodebasej.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.nodebasej.crypto.DeterministicKey#deserializeB58(org.nodebasej.crypto.DeterministicKey, String, org.nodebasej.core.NetworkParameters)}
 ...
 *
 * <p>This class builds on {@link org.nodebasej.crypto.DeterministicHierarchy} and
 * {@link org.nodebasej.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.nodebasej.crypto.DeterministicKey)}
     ...
     * @see org.nodebasej.wallet.MarriedKeyChain
     */
