...
/**
 * <p>A KeyChainGroup is used by the {@link org.nodebasej.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.nodebasej.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.nodebasej.crypto.KeyCrypterScrypt}.
     *
     * @throws org.nodebasej.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
