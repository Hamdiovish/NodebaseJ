...
import org.nodebasej.net.discovery.HttpDiscovery;
import org.nodebasej.params.*;
import org.nodebasej.script.Script;
import org.nodebasej.script.ScriptBuilder;
import org.nodebasej.script.ScriptChunk;
import org.nodebasej.script.ScriptOpCodes;
...
import org.nodebasej.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try
        {
          ...
          byte[] pubKey = Utils.HEX.decode(CoinDefinition.SATOSHI_KEY);
          ScriptBuilder scriptBuilder = new ScriptBuilder().addChunk(new ScriptChunk(65, pubKey)).op(172);
    ...
    private static Block _createGenesis(NetworkParameters n) {
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.nodebasej.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.nodebasej.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.nodebasej.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.nodebasej.core.AlertMessage}s. You can use {@link org.nodebasej.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
